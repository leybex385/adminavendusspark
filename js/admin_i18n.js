...
(function () {
    const translations = {
        cn: {
            ...
            "lbl_price": "价格",
            "th_symbol": "股票代码",
            "btn_update_prices": "更新市场价格",
            "lbl_edit": "编辑",
            "lbl_product_type": "产品类型",
            "lbl_exchange": "交易所",
            "lbl_market_symbol": "市场代码",
            "lbl_estimated_profit_pct": "预计收益 (%)",
            "modal_confirm_price_sync_title": "确认价格同步",
            "modal_confirm_price_sync_desc": "系统将从 Yahoo Finance 获取所有已启用产品的最新市场价格。是否继续？",
            "btn_modal_ok": "确认",
            "lbl_notification": "通知",
            "lbl_syncing_prices": "正在同步价格...",
            "msg_sync_result": "已更新: {updated} | 失败: {failed}",
            "msg_sync_success_multi": "成功同步了 {count} 个产品",
            "msg_sync_error_user": "价格同步过程中发生错误，请检查股票代码或稍后重试。",
        ...
        en: {
            ...
            "lbl_price": "Price",
            "th_symbol": "Symbol",
            "btn_update_prices": "Update Market Prices",
            "lbl_edit": "Edit",
            "lbl_product_type": "Product Type",
            "lbl_exchange": "Exchange",
            "lbl_market_symbol": "Market Symbol",
            "lbl_estimated_profit_pct": "Estimated Profit (%)",
            "modal_confirm_price_sync_title": "Confirm Price Sync",
            "modal_confirm_price_sync_desc": "This will fetch live prices for all active products from Yahoo Finance. Continue?",
            "btn_modal_ok": "OK",
            "lbl_notification": "Notification",
            "lbl_syncing_prices": "Syncing prices...",
            "msg_sync_result": "Updated: {updated} | Failed: {failed}",
            "msg_sync_success_multi": "Successfully synced {count} products",
            "msg_sync_error_user": "An error occurred while syncing prices. Please check the stock symbol or try again later.",
